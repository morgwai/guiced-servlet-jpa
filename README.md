...
<br/>
**latest release: [1.1](https://search.maven.org/artifact/pl.morgwai.base/guiced-servlet-jpa/1.1/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guiced-servlet-jpa/1.1))
